...
def index(request):
    ...
    try:
        ...
        hotest_list = article_list.order_by('-reading_quantity')
        hotest_list = hotest_list[0:6]
        info = {'page_project':page_project, 'paginator':paginator, 'hotest_list':hotest_list}
...
def project_detail(request, project_id):
    ...
    try:
        ...
        hotest_list = article_list.order_by('-reading_quantity')
        hotest_list = hotest_list[0:6]
        info = {'project': project, 'task_list': task_list, 'hotest_list':hotest_list}
